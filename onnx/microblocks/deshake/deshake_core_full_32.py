...
class DeshakeCoreFull(MicroblockBase):
    ...
    def build_algo(self, stage: str, prev_stages=None):
        ...
        # Use fixed mesh size (32x32)
        mesh_h = f'{stage}.mesh_h'
        mesh_w = f'{stage}.mesh_w'
        inits.append(oh.make_tensor(mesh_h, TensorProto.INT64, [], [self.mesh_h]))
        inits.append(oh.make_tensor(mesh_w, TensorProto.INT64, [], [self.mesh_w]))
