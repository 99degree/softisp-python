...
class DeshakeCoreSimple(MicroblockBase):
    """
    DeshakeCoreSimple - Core Processing Stage (Coordinator Domain)
    ---------------------------------------------------------------
    ...
    Use Case: Core processing without IMU dependency
    """
    name = 'deshake_core_simple'
    family = 'deshake_core'
    version = 'v1'
