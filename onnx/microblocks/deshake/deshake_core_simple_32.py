...
class DeshakeCoreSimple32(MicroblockBase):
    """
    ...
    Provides:
        - mesh_grid [32,32,2] : Mesh vertex grid for warp
        - valid_mask [32,32] : Valid region mask
    ...
    Mesh Grid Generation Steps:
        1. Create normalized identity grid (32x32)
    ...
    Use Case: Core processing without IMU dependency, 32x32 mesh grid
    """
    ...
    def build_algo(self, stage: str, prev_stages=None):
        ...
        # Create mesh coordinate grid (32x32)
