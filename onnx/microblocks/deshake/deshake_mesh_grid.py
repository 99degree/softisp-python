...
class DeshakeMeshGridBase(MicroblockBase):
    """
    DeshakeMeshGridBase - Base Mesh Grid Generator (Coordinator Domain)
    ---------------------------------------------------------------
    COORDINATOR: Generate mesh grid from homography matrix.
    
    Position: After algo, before applier.
    
    Purpose: Generate mesh grid from homography matrix for mesh-based warp.
    ...
    Behavior:
        ...
        - build_coordinator: Generate mesh grid from homography
    ...
    Use Case: Base mesh grid generator
    """
    name = 'deshake_mesh_grid_base'
    ...
    def build_coordinator(self, stage: str, prev_stages=None):
        """
        Generate mesh grid from homography matrix.
        """
        vis, nodes, inits = ([], [], [])
