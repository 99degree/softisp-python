...
class GammaBase(MicroblockBase):
    ...
    Input:  [n,3,h,w] (RGB)
    Output: [n,3,h,w] (gamma corrected RGB)
    ...
    def build_applier(self, stage: str, prev_stages=None):
        ...
        result.appendInput(gamma, type=TensorProto.FLOAT, shape=[1])
        return result
    ...
    def build_algo(self, stage: str, prev_stages=None):
        ...
        outputs = {
            "applier":     {"name": out_name, "type":TensorProto.FLOAT, "shape":["n", 3, "h", "w"]},
            "gamma_value": {"name": gamma_out, "type":TensorProto.FLOAT, "shape":[1]},  # visible output
        }
