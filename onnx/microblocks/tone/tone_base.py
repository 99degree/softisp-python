...
class ToneMapBase(MicroblockBase):
    ...
    def build_applier(self, stage: str, prev_stages=None):
        ...
        result.appendInput(input_image, type=TensorProto.FLOAT, shape=["n", 3, "h", "w"])  # upstream image
        result.appendInput(curve,type=TensorProto.FLOAT, shape=[1])        # independent curve
        return result
    ...
    def build_algo(self, stage: str, prev_stages=None):
        ...
        curve = f"{stage}.tonemap_curve_src"
        ...
        curve_out = f"{stage}.tonemap_curve"
        ...
        outputs = {
            "applier": {"name": out_name, "type":TensorProto.FLOAT, "shape":["n", 3, "h", "w"]},
            "tonemap_curve": {"name": curve_out, "type":TensorProto.FLOAT, "shape":[1]},  # visible output
        }
