...
"""
Test auto exposure modules directly without going through __init__.py
"""
...
def test_config_classes():
    ...
    try:
        # Import config classes directly from their files
        import microblocks.autoexposure.autoexposure_config as ae_config
...
def test_utility_classes():
    ...
    try:
        ...
        import microblocks.autoexposure.autoexposure_config as ae_config
        import microblocks.autoexposure.autoexposure_utils as ae_utils
...
def run_all_tests():
    """Run all tests"""
    print("=" * 70)
    print("AUTO EXPOSURE DIRECT MODULE TEST (NO ONNX DEPENDENCY)")
    print("=" * 70)
    print()
